...
func List() error {
	...
	if err != nil {
		return fmt.Errorf("unable to read costumes in %s: %v (run 'wardrobe get' first)", costumesDir, err)
	}

	utils.LogNormal(utils.ColorCyan + "Available costumes in wardrobe:" + utils.ColorReset)
